            ...
            <div class="footer__left">
                <div class="footer__wrapper alr _anim-items _anim-off">
                    <div class="footer__place">
                        <div class="footer__place_icon"><svg width="24" height="32" viewBox="0 0 24 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.0013 0.167969C5.8738 0.167969 0.917969 5.1238 0.917969 11.2513C0.917969 19.5638 12.0013 31.8346 12.0013 31.8346C12.0013 31.8346 23.0846 19.5638 23.0846 11.2513C23.0846 5.1238 18.1288 0.167969 12.0013 0.167969ZM12.0013 15.2096C9.8163 15.2096 8.04297 13.4363 8.04297 11.2513C8.04297 9.0663 9.8163 7.29297 12.0013 7.29297C14.1863 7.29297 15.9596 9.0663 15.9596 11.2513C15.9596 13.4363 14.1863 15.2096 12.0013 15.2096Z" fill="#E0B76E"/>
                            </svg>
                        </div>
                    ...
                    <div class="footer__contacts">
                        <div class="footer__contacts_icon"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.48167 13.0842C8.76167 17.565 12.435 21.2225 16.9158 23.5183L20.3992 20.035C20.8267 19.6075 21.46 19.465 22.0142 19.655C23.7875 20.2408 25.7033 20.5575 27.6667 20.5575C28.5375 20.5575 29.25 21.27 29.25 22.1408V27.6667C29.25 28.5375 28.5375 29.25 27.6667 29.25C12.7992 29.25 0.75 17.2008 0.75 2.33333C0.75 1.4625 1.4625 0.75 2.33333 0.75H7.875C8.74583 0.75 9.45833 1.4625 9.45833 2.33333C9.45833 4.3125 9.775 6.2125 10.3608 7.98583C10.535 8.54 10.4083 9.1575 9.965 9.60083L6.48167 13.0842Z" fill="#E0B76E"/>
                            </svg>
                        </div>

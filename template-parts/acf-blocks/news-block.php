						...
						<?php foreach($posts as $post): ?>
							...
							<li class="col-12 col-md-6 col-lg-4 newsBlock__item appear fade-up">
								<div class="newsBlock__item__inner">
                                    <a href="<?php echo $permalink; ?>" class="newsBlock__item__image" <?php echo get_field('open_on_external_link')?'target="_10-corso-como"':''; ?>>
										<?php if($image): ?>
											<img class="newsBlock__item__bg lazy-img" data-src="<?php echo $image; ?>" alt="<?php echo $title; ?>" />
										<?php endif; ?>
                                    </a>
									<div class="newsBlock__item__content">
                                        <a class="newsBlock__item__content__link" href="<?php echo $permalink; ?>" <?php echo get_field('open_on_external_link')?'target="_10-corso-como"':''; ?>>
